        ...
        <template v-if="tableData.length > 0">
            ...
            >
                ...
                <el-table-column label="月淨現金流" width="120" align="right">
                    <template #default="{ row }">
                        <span :class="getNetCashFlow(row) >= 0 ? 'text-success' : 'text-danger'" class="font-mono font-bold">
