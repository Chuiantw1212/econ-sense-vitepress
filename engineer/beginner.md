...
根據統計，[台灣的平均待業時間約為20週](https://www.stat.gov.tw/News.aspx?n=4001&sms=11516)，約5個月。這意味著在尋找新工作時，應該確保你有足夠的緊急預備金來應對這段過渡期。建議至少準備6個月的生活開支，這樣可以確保你在待業期間不會因資金壓力而影響求職策略，並且能夠專心尋找最合適的職位。

#### 接案與作品集擴充

同時，為了避免承接的專案「爛尾」而影響個人聲譽，建議接下那些可以在短時間內完成的專案，特別是六日內可完成的短期案子。這樣，即使你在求職期間找到全職工作，也不會因為時間管理不當而導致專案無法順利結束。透過像 [pro360](https://www.pro360.com.tw/) 這類接案平台，你可以靈活承接各類專案，既能擴充你的作品集，又能保持穩定的收入來源。
