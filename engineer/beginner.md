...
以我自己的經驗為例，我曾經面試並進入了一間號稱是區塊鍊技術的公司，但進去後才發現該公司實際上是做生技的，所謂的區塊鍊技術只是用來吸引投資的名目。這樣的情況不僅浪費了我的時間，也讓我在職涯規劃上走了些彎路。因此，提前了解公司的營業項目可以幫助你在面試時更有針對性地提問，確認工作內容與職位描述（JD）是否一致，從而避免進入與預期不符的公司。
