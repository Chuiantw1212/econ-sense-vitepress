...
熵腦模型中 I/O 維度的二元對立，在現代神經科學中獲得了最具體的結構性驗證。賓夕法尼亞大學的 Ingalhalikar 等人 (2014) 在《美國國家科學院院刊 (PNAS)》發表的研究中，透過擴散張量成像 (DTI) 技術繪製了近千人的大腦連結組圖譜，揭示了人類大腦存在兩套截然不同的「神經佈線 (Hard-wiring)」模式。研究發現，I (Individual) 驅力對應的大腦架構展現出高度的**半球內連結 (Intra-hemispheric connectivity)**，神經訊號主要在單一腦半球的前後區域間流動，這種佈線優化了「感知」到「行動」的直接傳導效率，為獵人原型的空間導航與執行力提供了物理基礎。相對地，O (Other) 驅力對應的大腦架構則擁有顯著密集的**跨半球連結 (Inter-hemispheric connectivity)**，透過胼胝體緊密整合左腦的邏輯分析與右腦的直覺整體，這種佈線是為了同時處理複雜訊號與多工協作而生，完美支援了採集者原型的資源整合與環境掃描能力。
