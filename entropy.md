...
**I 驅力（獵人腦）** 對應於演化中的狩獵需求，受高濃度睪固酮影響，大腦右半球與視覺空間模組高度特化，形成「隧道視野 (Tunnel Vision)」。這種機制能忽略背景噪音（減熵），專注於動態目標的軌跡運算與心理旋轉，這正是 D 型風格具備宏觀戰略與目標導向的演化根源。相對地， **O 驅力（採集者腦）** 對應於採集與撫育需求，大腦發展出卓越的「廣角視野」與物體位置記憶 (Object Location Memory)。這種機制允許個體在複雜環境中同時處理多重靜態訊號與社交網絡變化（容納高熵），這解釋了 S 型風格在人際連結、細節察覺與環境掃描上的天然優勢。
...
熵腦模型中 I/O 維度的二元對立，在現代神經科學中獲得了最具體的結構性驗證。賓夕法尼亞大學的 Ingalhalikar 等人 (2014) 在《美國國家科學院院刊 (PNAS)》發表的研究中，透過擴散張量成像 (DTI) 技術繪製了近千人的大腦連結組圖譜，揭示了人類大腦存在兩套截然不同的「神經佈線 (Hard-wiring)」模式。研究發現，I 型驅力（生物雄性典型）的大腦展現出高度的**半球內連結 (Intra-hemispheric connectivity)**，神經訊號主要在單一腦半球的前後區域間流動，這種架構優化了「感知」到「行動」的直接傳導效率，為 D 型風格的單點突破與空間執行力提供了物理基礎。相對地，O 型驅力（生物雌性典型）的大腦則擁有顯著密集的**跨半球連結 (Inter-hemispheric connectivity)**，透過胼胝體緊密整合左腦的邏輯分析與右腦的直覺整體，這種架構是為了同時處理複雜的社會訊號與多工協作而生，完美對應了 S 型風格的資源整合與連結特質。

| 比較維度 | I (Individual) 獵人佈線 | O (Other) 採集者佈線 |
| :--- | :--- | :--- |
| **神經連結模式** | **半球內連結** (Intra-hemispheric)<br>神經網絡主要在單一腦半球內部形成迴路 | **跨半球連結** (Inter-hemispheric)<br>神經網絡頻繁穿過胼胝體，連結左右腦 |
| **訊號流動方向** | **前後流動** (Front-to-Back)<br>連結前額葉（運動/決策）與小腦/視覺區（感知） | **左右流動** (Left-to-Right)<br>連結左腦（語言/邏輯）與右腦（直覺/空間） |
| **認知優勢功能** | **感知-行動 協調** (Perception-Action)<br>優化空間定位、運動反應與單一目標執行 | **分析-直覺 整合** (Analysis-Intuition)<br>優化社會認知、語言記憶與多工處理能力 |
| **硬體運作邏輯** | **模組化處理** (Modular)<br>各腦區獨立運作效率高，適合專注任務 (Focus) | **全腦整合處理** (Integrative)<br>調動全腦資源協作，適合複雜情境判讀 (Scan) |
