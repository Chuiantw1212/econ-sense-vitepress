---
outline: [2,4]
title: 腦模型研究：解構 DiSC 與 MBTI 背後的演化心理學與神經科學基礎
description: 深入探索「熵腦模型」的學術基石：從演化心理學的獵人-採集者假說，到神經科學的大腦連結組學與 PNAS 實證研究。本文跨領域解密 I/O、R/V、H/C 三大維度如何與 DiSC、榮格心智功能精確對應。透過大腦神經佈線、多巴胺代謝與熱力學熵，為人類行為驅力提供最具科學硬核力的底層合理解釋。
---
...
熵腦模型（Entropy Brain Model）的核心論點在於：人類的行為表現並非隨機的性格偏好，而是大腦在處理資訊流與能量管理時的「物理選擇」。我們透過三個核心維度——I/O (個體他者)、R/V (現證內觀)、以及 H/C (熱動冷控)，勾勒出人類心智運作的立體矩陣。

這三大維度分別代表了生命系統的三個層級：「演化與社會策略（I/O）」、「空間與現實感知（R/V）」、以及 **「生物能量與動力管理（H/C）」**。為了驗證這套模型的嚴謹性，我們將從神經科學的佈線圖譜、演化心理學的獵人-採集者假說，以及物理學的熵增定律出發，為每一維度建立堅實的學理基石。
