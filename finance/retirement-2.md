...
[**國稅局的單一窗口查詢金融遺產**](https://www.ntbt.gov.tw/multiplehtml/d0fb820339664903a443ef214be0bbce)是一項便捷服務，旨在協助民眾在家人離世後快速查詢其名下的所有金融資產。過去需透過多個銀行或金融單位逐一查詢，但現在只需透過國稅局提供的「單一窗口」服務，即可查閱完整的金融遺產資訊，包括存款、股票、基金、保險及其他金融工具。此系統讓遺產的查詢流程大幅簡化，並減少遺產處理的時間與精力，是處理遺產時的重要工具。

這項服務不僅對遺族有幫助，也能減少遺產分配中的資產遺漏風險。查詢的流程也相對簡單，只需向國稅局提出申請並提供必要文件，審核後便可取得查詢結果。
