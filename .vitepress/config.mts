    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '🏹 獵人 IRH', link: '/entropy/hunter' },
          { text: '🧭 先驅 IVH', link: '/entropy/pioneer' },
          { text: '🍇 採集者 ORH', link: '/entropy/gatherer' },
          { text: '🦋 薩滿 OVH', link: '/entropy/shaman' },
          { text: '🛠 工匠 IRC', link: '/entropy/toolmaker' },
          { text: '🛡️ 哨兵 IVC', link: '/entropy/sentry' },
          { text: '🫂 助人者 ORC', link: '/entropy/helper' },
          { text: '🌳 長老 OVC', link: '/entropy/elder' },
